...
class Zend_Controller_Request_Http extends Zend_Controller_Request_Abstract
{
    ...
    public function getRawBody() {
        if (null === $this->_rawBody) {
            ...
            // Temporary code to escape illegal XML characters, please delete lines when input XML is valid.
            if (strpos($body, '<word>') && strpos($body, '</word>')) {
                list ($xmlStrBeforeWordStartTag, $xmlStrAfterWordStartTag) = explode('<word>', $body);
                list ($xmlStrBetweenWordTag, $xmlStrAfterWordEndTag) = explode('</word>', $xmlStrAfterWordStartTag);
                $body = $xmlStrBeforeWordStartTag . '<word>' . htmlspecialchars($xmlStrBetweenWordTag) . '</word>' . $xmlStrAfterWordEndTag;
            }
