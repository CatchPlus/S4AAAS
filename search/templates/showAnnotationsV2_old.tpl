...
<div class='image-holder radius'>
    <div class='links'>
        ...
        {if $v->marked_wordzone != ''}
            <a href='{$v->marked_wordzone}' class='showpage'>toon pagina</a>
...
{
    "x": {if ($v->x|ltrim:'0') == ''}0{else}{$v->x|ltrim:'0'}{/if},
    "y": {if ($v->y|ltrim:'0') == ''}0{else}{$v->y|ltrim:'0'}{/if},
    "h": {if ($v->h|ltrim:'0') == ''}0{else}{$v->h|ltrim:'0'}{/if},
    "w": {if ($v->w|ltrim:'0') == ''}0{else}{$v->w|ltrim:'0'}{/if},
...
{/if}*}
    ...
    <div class='info'>
        ...
        <span class='type'>Type: {$types.$theType}</span>
