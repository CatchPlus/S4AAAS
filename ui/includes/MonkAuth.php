...
class MonkAuth {
    ...
    public function init() {
        try {
            ...
            $_SESSION['errorMessage'] = 'Er zijn geen boeken om te transcriberen. Ga terug naar de <a href="' . Config::SEARCH_URL . '">zoek</a> pagina.';
...
//        header("Location: " . Config::AUTH_URL . '&appid=' . Config::APPID);
    ...
    private function retrieveUserRoleAndBooks() {
        ...
        try {
            $bookListResponse = $pestXML->post('/rest/list_pages/', '<list_pages>
